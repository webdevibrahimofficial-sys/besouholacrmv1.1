...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('landlord')->hasTable('tenant_backup_restores')) {
            return;
        }

        Schema::connection('landlord')->create('tenant_backup_restores', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('landlord')->dropIfExists('tenant_backup_restores');
    }
};
