...
return new class extends Migration
{
    ...
    {
        if (Schema::connection('landlord')->hasTable('admin_notification_settings')) {
            return;
        }

        Schema::connection('landlord')->create('admin_notification_settings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('landlord')->dropIfExists('admin_notification_settings');
    }
};
