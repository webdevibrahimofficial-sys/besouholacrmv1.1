          ...
          {RANKING.map(({ name, actions }, index) => (
            <div key={name} className="flex items-center gap-2">
              ...
              <div className="text-right">
                <div className="text-[0.95rem] font-bold leading-none text-accent-purple">{actions}</div>
        ...
        <div className="grid grid-cols-1 gap-7 lg:grid-cols-[minmax(0,0.98fr)_minmax(500px,1.02fr)] lg:items-start lg:gap-4 xl:gap-5 2xl:gap-6">
          <div className="max-w-2xl lg:max-w-[40rem] lg:pt-1 xl:pt-2">
            ...
            <motion.h1
              ...
              className="mb-3 max-w-[18ch] text-[clamp(2.15rem,8vw,3.25rem)] font-bold uppercase leading-[1] text-white sm:max-w-[18ch] sm:text-[clamp(2.5rem,7vw,3.45rem)] lg:max-w-[16ch] lg:text-[2.85rem] xl:max-w-[16ch] xl:text-[3.1rem] 2xl:text-[3.35rem]"
            >
            ...
            <motion.p
              ...
              className="mb-4 max-w-xl text-[0.98rem] leading-[1.55] text-gray-300 md:text-[1.02rem]"
            >
            ...
            <motion.div
              ...
              className="mt-3 flex flex-col gap-1.5 text-sm text-gray-300 sm:flex-row sm:flex-wrap sm:gap-x-4 sm:gap-y-1.5"
            >
              {TRUST_BULLETS.map((item) => (
                <div key={item} className="flex items-center gap-2">
                  <span className="text-[0.92rem] font-semibold text-accent-purple">✓</span>
                  <span>{item}</span>
                </div>
              ))}
            </motion.div>
