            ...
            <div key={country.id} className="card dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-4">
              <div className="flex justify-between items-start">
                <div className="space-y-1">
                  <h4 className="font-semibold text-theme-text dark:text-white">{isArabic ? (country.nameAr || country.nameEn) : country.nameEn}</h4>
                  <p className="text-sm text-theme-text">{isArabic ? country.nameEn : country.nameAr}</p>
                </div>
