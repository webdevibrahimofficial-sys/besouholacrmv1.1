...
const LandingSharedPage = lazyRetry(() => import('../pages/landing-themes/LandingSharedPage'))
  ...
  return (
    <div className={i18n.language === 'ar' ? 'rtl' : 'ltr'}>
      <Suspense fallback={
        ...
        <Route path="/landing-preview/:slug" element={<LandingPagePreview />} />
        <Route path="/l/:slug/:token" element={<LandingSharedPage />} />
