...
import { BriefcaseBusiness, Building2, Edit, Layers3, Plus, Rocket, Search, ShieldCheck, Star, Trash2, X } from 'lucide-react'
      ...
      <div className="relative z-10">
        <header className="mb-10">
          <div className="flex gap-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
            ...
            <button
              ...
              className="flex shrink-0 items-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2 text-sm text-white shadow-md shadow-blue-500/25 transition-colors hover:bg-blue-700"
            >
              <Plus size={14} />
              {t('Create Plan')}
            </button>
        ...
        <section className={`${glassCard} mb-5 px-4 py-4 md:px-5 mt-2`}>
          <div className="flex  gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex  gap-3 sm:flex-row sm:items-center lg:min-w-[520px]">
              ...
              <div className={`inline-flex rounded-xl border p-1 backdrop-blur-md ${
          ...
          <section className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            {filteredPlans.map((plan) => {
              ...
              return (
                <article
                  key={plan.id}
                  className={`group relative overflow-hidden rounded-[20px] border p-4 backdrop-blur-xl transition-all duration-200 hover:-translate-y-0.5 ${
                    isDark
